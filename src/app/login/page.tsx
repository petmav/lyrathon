      ...
      >
        ...
        >
          ...
          <Box sx={{ display: "grid", gap: 1 }}>
            ...
            <Typography variant="body1" sx={{ color: "#b7c2d9", maxWidth: 520 }}>
              Continue tracking recruiter queries, shortlist decisions, and keep your profile
              synced across the stack.
            </Typography>
          </Box>
        ...
        >
          ...
          >
            ...
            <Link href={"/register"} style={{ color: "#9a6bff", fontWeight: 700 }}>
              Sign up
            </Link>
          </Typography>
        </Paper>
